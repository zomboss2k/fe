...
function Index() {
    ...
    const _onDiscusion = (id) => {
     ...
     const getImage = (index) =>{
        ...
        return ("http://127.0.0.1:5000/api/getimage/"+index);
    } 
                                ...
                                <div className="row">
                                    <div style={{ 'padding-left': '20px' }} >
                                        <Button variant="link" id='cmt' onClick={() => _onDiscusion(row.post_ID)}>
                                            <img src={getImage(getID(row.post_ID))} alt="" class="img-thumbnail" style={{ 'width': '300px', 'padding': '0px 15px' }}></img>
                                        </Button>
                                    </div>
                                    <div className="col">
